function render(incoming_frame) {
    var sobel = [[-1,-1,-1],
                [-1,8,-1],
                [-1,-1,-1]];
    ...
    //previous image onload
    var img = incoming_frame;
    //img.onload = function () {
        input_context.drawImage(img,0,0,input.width,input.height);
        ...
        output_context.putImageData(finalImage,0,0,output.width,output.height);
    //}
    ////////////////////////////////
